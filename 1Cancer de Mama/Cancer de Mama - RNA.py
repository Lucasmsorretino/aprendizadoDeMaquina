...
df = pd.read_csv('/Users/jaimewojciechowski/Dropbox/Jaime/AA-UFPR/EspecializacaoIAA2026/Praticas Python/1 – Cancer de Mama/Cancer de Mama - Dados.csv',sep=',')
...
print(' ')
print('###################')
print('Conteúdo do arquivo - Cancer de Mama')
print(df.head())
...
print('###########################')
print('EXPERIMENTO RNA - Câncer Mama - HOLD-OUT')
print("Acurácia:", accuracy_score(y_test, y_pred))
print("\nRelatório de Classificação:\n", classification_report(y_test, y_pred))
conf_matrix = confusion_matrix(y_test, y_pred)
print(' ')
print('RNA - Câncer Mama - Matriz de Confusão - HOLD-OUT')
print(conf_matrix)
...
grid = GridSearchCV(MLPClassifier(), param_grid, n_jobs= -1, cv=10)
grid.fit(X_train, y_train)

print(' ')
print('###########################')
print('EXPERIMENTO RNA - Cancer de Mama - CV')
print(' ')
...
print(' ')
print('RNA - Cancer de Mama - Matriz de Confusão - CV')
print(conf_matrix)
...
dados_novos_path = "/Users/jaimewojciechowski/Dropbox/Jaime/AA-UFPR/EspecializacaoIAA2026/Praticas Python/1 – Cancer de Mama/Cancer de Mama - Novos Casos - Para Python.csv"  # CSV SEM a variável alvo
...
dados_novos.to_csv("/Users/jaimewojciechowski/Dropbox/Jaime/AA-UFPR/EspecializacaoIAA2026/Praticas Python/1 – Cancer de Mama/Cancer de Mama - Novos Casos - Predicoes em Python RNA.csv", index=False)
print("\nPredições salvas em 'Cancer de Mama - Novos Casos - Predicoes em Python.csv'")
