...
# Define a semente para o bootsptrap
random_seed = 196572
...
print(' ')
print('###########################')
print('EXPERIMENTO RF - Câncer de Mama - HOLD-OUT')
...
print('###########################')
print('EXPERIMENTO RNA - Câncer de Mama - HOLD-OUT')
...
print(' ')
print('###########################')
print('EXPERIMENTO RF - Cancer de Mama - CV')
print(' ')
...
print(' ')
print('RF - Cancer de Mama - Matriz de Confusão - CV')
print(conf_matrix)
...
dados_novos_path = "/Users/jaimewojciechowski/Dropbox/Jaime/AA-UFPR/EspecializacaoIAA2026/Praticas Python/1 – Cancer de Mama/Cancer de Mama - Novos Casos - Para Python.csv"  # sem a variável alvo
...
dados_novos.to_csv("/Users/jaimewojciechowski/Dropbox/Jaime/AA-UFPR/EspecializacaoIAA2026/Praticas Python/1 – Cancer de Mama/Cancer de Mama - Novos Casos - Predicoes em Python RF.csv", index=False)

# Exibir resultados
print("Predições realizadas com sucesso.")
print(dados_novos[['predicao']])
print("Arquivo salvo como 'Cancer de Mama - Novos Casos - Predicoes em Python RF.csv'")
