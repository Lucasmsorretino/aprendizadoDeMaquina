...
print(' ')
print('###################')
print('Conteúdo do arquivo - Câncer de Mama')
print(df.head())
...
##############################################
# EXPERIMENTO
#param_grid = {'n_neighbors': [1, 3, 5, 7, 9]} #opção de grid

k_range = list(range(1, 9, 2))  #de 1 até 9 de 2 em 2
param_grid = {
    'n_neighbors': k_range,
...
print(' ')
print('###########################')
print('EXPERIMENTO KNN - Cancer de Mama')
print(' ')
...
print(' ')
print('KNN - Cancer de Mama - Matriz de Confusão')
print(conf_matrix)
...
dados_novos.to_csv("/Users/jaimewojciechowski/Dropbox/Jaime/AA-UFPR/EspecializacaoIAA2026/Praticas Python/1 – Cancer de Mama/Cancer de Mama - Novos Casos - Predicoes em Python KNN.csv", index=False)
print("Arquivo salvo como '/Cancer de Mama - Novos Casos - Predicoes em Python KNN.csv'")
