...
print(' ')
print('###########################')
print('EXPERIMENTO KNN - Diabetes')
print(' ')
...
print(' ')
print('KNN - Diabetes - Matriz de Confusão')
print(conf_matrix)
...
dados_novos.to_csv("Diabetes - Novos Casos - Predicoes em Python KNN.csv", index=False)
print("\nPredições salvas em 'Diabetes - Novos Casos - Predicoes em Python KNN.csv'")
