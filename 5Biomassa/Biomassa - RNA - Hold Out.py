...
params = {"hidden_layer_sizes": 100, "max_iter": 1000, "random_state": 42}
...
resultados:
[{'MODELO': 'MLPRegressor', 'MAE': 169.53755523707298, 'MSE': 171917.41856531904, 'RMSE': np.float64(414.6292543529931), 'R2': 0.5568533413042853, 'MAPE': np.float64(111.66704752292394), 'MedAE': 70.45386527674725, 'PearsonR': np.float64(0.8817451242695417), 'syx': np.float64(44.71062234815709), 'params': {'hidden_layer_sizes': 100, 'activation': 'tanh', 'max_iter': 1000, 'random_state': 42}}]
...
"""
Predições para novos casos:
[29.40747438 44.97909396 27.18090601 42.29618811]
"""